...
const docTemplate = `{
        ...
        "/nodes/file": {
            "post": {
                ...
                "responses": {
                    ...
                    "413": {
                        "description": "Payload Too Large - either the request exceeds 1GB or the owner's storage quota is exceeded.",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/nodes/{nodeId}/copy": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Node ID of the file/folder to copy",
                        "name": "nodeId",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Target parent folder and optional new name",
                        "name": "copyRequest",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.CopyNodeRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "Not Found - Source or destination not found",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/nodes/{nodeId}/share": {
            "post": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Not Found - Node or recipient not found",
                        "schema": {
                            "type": "string"
                        }
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/serwer-plikow_internal_models.Session"
                            }
                        }
                    },
                    "401": {
    ...
    "definitions": {
        ...
        "serwer-plikow_internal_models.Session": {
            "type": "object",
            "properties": {
                "client_ip": {
                    "type": "string",
